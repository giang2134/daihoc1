...
classes = { 1:'Giới hạn tốc độ (20km/h)',
            ...
            7:'End of Giới hạn tốc độ (80km/h)', 
...
upload=Button(top,text="Tải lên",command=upload_image,padx=10,pady=5)
upload.configure(background='#364156', foreground='white',font=('arial',10,'bold'))

upload.pack(side=BOTTOM,pady=50)
sign_image.pack(side=BOTTOM,expand=True)
label.pack(side=BOTTOM,expand=True)
heading = Label(top, text="Biển báo bạn muốn biết",pady=20, font=('arial',20,'bold'))
